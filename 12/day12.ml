...
let step (m1, v1) (m2, v2) (m3, v3) (m4, v4) = 
...
let step1 = step (ma, zero_v) (mb, zero_v) (mc, zero_v) (md, zero_v)

let step2 = match step1 with
  | [(p1,v1);(p2,v2);(p3,v3);(p4,v4);] -> step (p1,v1) (p2, v2) (p3, v3) (p4, v4)
  | _ -> failwith "invalid step"

let () = print_step step2
